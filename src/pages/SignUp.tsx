    ...
    return (
        <div className="flex flex-col items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8">
                <div>
                    <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">{t('Create a new account')}</h2>
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    <div className="rounded-md shadow-sm -space-y-px">
                        ...
                        <div>
                            <label htmlFor="confirm-password" className="sr-only">{t('Confirm password')}</label>
                            <input
                                id="confirm-password"
